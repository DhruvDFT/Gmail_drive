...
def index():
    ...
    <body>
            ...
            <div class="content">
                ...
                <div id="auth-section" class="auth-section">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn" onclick="authenticate()">🔑 Login</button>
                    </div>
                    <p>Default password: <code>admin123</code> (change via ADMIN_PASSWORD env var)</p>
                    <button type="button" class="btn" onclick="testConnection()" style="background: #6c757d;">🔧 Test Connection</button>
                    <div id="auth-debug" style="margin-top: 10px; padding: 10px; background: #f8f9fa; border-radius: 5px; font-size: 0.9em; color: #666; min-height: 30px;">
        ...
        // Handle Enter key in password field and initialize
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (passwordField) {
                ...
                debugLog("✅ Password field event listener added");
            } else {
                debugLog("❌ Password field not found!");
            }
